...
class EvaluacionesDropBoxDriveSteps:
    ...
    @staticmethod
    def ingreso_pagina_principal_dropbox(webdriver_test_ux: WebDriver, json_eval):
        tiempo_step_inicio = None
        fecha_inicio = Temporizador.obtener_fecha_tiempo_actual()

        try:
            url_pagina_principal = FormatUtils.lector_archivo_ini().get('Dropbox_config', 'url_login')
    ...
    def inicio_sesion_dropbox(webdriver_test_ux: WebDriver, json_eval, json_args):
        ...
        try:
            ...
            if modo_no_grafico:
                ...
                HtmlActions.webdriver_wait_presence_of_element_located(div_form, 10, name='password')
                HtmlActions.webdriver_wait_presence_of_element_located(div_form, 10, name='password')
                HtmlActions.webdriver_wait_presence_of_element_located(div_form, 10, name='password')
    ...
    def cargar_archivo_dropbox(webdriver_test_ux: WebDriver, json_eval, json_args, nombre_archivo_sin_ext,
        ...
        try:
            ...
            HtmlActions.enviar_data_keys(input_carga_de_archivo, data_key=json_args['pathImage'],
            ...
            HtmlActions.webdriver_wait_visibility_of_element_located(
                webdriver_test_ux, 720, xpath='//span[@class="dig-Snackbar-message "][text()="Se carg\u00F3 {}."]'.
    ...
    def eliminar_archivo_dropbox(webdriver_test_ux: WebDriver, json_eval, nombre_archivo_con_ext):
        ...
        try:
            ...
            HtmlActions.click_html_element(
                btn_eliminar_modal, xpath='//span[@class="mc-button-content"][text()="Eliminar"]')

            tiempo_step_inicio = Temporizador.obtener_tiempo_timer()

            HtmlActions.webdriver_wait_presence_of_element_located(
                webdriver_test_ux, 30, xpath='//span[@class="dig-Snackbar-message "][text()="Se elimin\u00F3 1 '
                                             'elemento."]')
